...
import { CommandArguments, sanitizeCommandArguments } from "./commands/commandArguments";
...
function registerCommand(
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand(commandId, async (context?: BlockchainIdentifier | vscode.Uri | any) => {
...
export async function activate(context: vscode.ExtensionContext) {
  ...
  const activeConnection = new ActiveConnection(blockchainsTreeDataProvider, blockchainMonitorPool);
  const contractDetector = new ContractDetector(activeConnection);
  const neoExpressInstanceManager = new NeoExpressInstanceManager(neoExpress, activeConnection);
  ...
  context.subscriptions.push(
    vscode.window.registerTreeDataProvider("neo3-visual-devtracker.views.blockchains", blockchainsTreeDataProvider)
  );

  context.subscriptions.push(
    vscode.window.registerTreeDataProvider("neo3-visual-devtracker.views.contracts", contractsTreeDataProvider)
  );

  context.subscriptions.push(
    vscode.window.registerTreeDataProvider("neo3-visual-devtracker.views.wallets", walletsTreeDataProvider)
  );
  ...
  registerCommand(context, "neo3-visual-devtracker.neo.newContract", () => Templates.newContract(context));

  registerCommand(context, "neo3-visual-devtracker.neo.walletCreate", () => NeoCommands.createWallet());

  registerCommand(context, "neo3-visual-devtracker.connect", () => activeConnection.connect());
  ...
  registerCommand(context, "neo3-visual-devtracker.express.customCommand", (commandArguments) =>
    NeoExpressCommands.customCommand(neoExpress, blockchainsTreeDataProvider, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.express.createCheckpoint", (commandArguments) =>
    NeoExpressCommands.createCheckpoint(neoExpress, blockchainsTreeDataProvider, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.express.exploreStorage", (commandArguments) =>
  ...
  registerCommand(context, "neo3-visual-devtracker.express.reset", (commandArguments) =>
    NeoExpressCommands.reset(neoExpress, neoExpressInstanceManager, blockchainsTreeDataProvider, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.express.restoreCheckpoint", (commandArguments) =>
    NeoExpressCommands.restoreCheckpoint(neoExpress, blockchainsTreeDataProvider, checkpointDetector, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.express.run", (commandArguments) =>
    neoExpressInstanceManager.run(blockchainsTreeDataProvider, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.express.runAdvanced", (commandArguments) =>
    neoExpressInstanceManager.runAdvanced(blockchainsTreeDataProvider, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.express.stop", (commandArguments) =>
    neoExpressInstanceManager.stop(blockchainsTreeDataProvider, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.express.transfer", (commandArguments) =>
    NeoExpressCommands.transfer(neoExpress, blockchainsTreeDataProvider, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.express.walletCreate", (commandArguments) =>
    NeoExpressCommands.walletCreate(neoExpress, blockchainsTreeDataProvider, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.neo.contractDeploy", (commandArguments) =>
    NeoCommands.contractDeploy(contractDetector, walletDetector, blockchainsTreeDataProvider, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.neo.invokeContract", (commandArguments) =>
    NeoCommands.invokeContract(activeConnection, blockchainsTreeDataProvider, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.tracker.openTracker", (commandArguments) =>
  ...
  registerCommand(context, "neo3-visual-devtracker.tracker.openContract", (commandArguments) =>
    TrackerCommands.openContract(context, autoComplete, commandArguments)
  );

  registerCommand(context, "neo3-visual-devtracker.tracker.openWallet", (commandArguments) =>
    TrackerCommands.openWallet(context, autoComplete, commandArguments, activeConnection)
  );
}
